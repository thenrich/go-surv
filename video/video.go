...
func main() {
	...
	if avformat.AvformatOpenInput(&pFormatContext, "rtsp://192.168.1.121/stream1", nil, nil) != 0 {
	...
	for i := 0; i < int(pFormatContext.NbStreams()); i++ {
		...
		case avformat.AVMEDIA_TYPE_VIDEO:
			...
			fmt.Println(avcodec.CodecId(pCodecCtxOrig.GetCodecId()))
			fmt.Println(pCodec)
			// Copy context
